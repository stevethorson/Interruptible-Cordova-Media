...
//////////////////////////////////
            ...
            if (!bError) {
                ...
                jsString = [NSString stringWithFormat:@"%@(\"%@\",%d,%.3f);\n%@(\"%@\",%d,%d);", @"window.Mediax.prototype.onStatus", mediaId, MEDIA_DURATION, position, @"window.Mediax.prototype.onStatus", mediaId, MEDIA_STATE, MEDIA_RUNNING];
        ...
        if (bError) {
            ...
            jsString = [NSString stringWithFormat:@"%@(\"%@\",%d,%@);", @"window.Mediax.prototype.onStatus", mediaId, MEDIA_ERROR, [self createMediaErrorWithCode:MEDIA_ERR_NONE_SUPPORTED message:nil]];
            [self.commandDelegate evalJs:jsString];
        }
    }
