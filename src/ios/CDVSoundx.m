...
- (void) myTest:(CDVInvokedUrlCommand*)command{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(onAudioSessionEvent:withId:) name:AVAudioSessionInterruptionNotification object:nil];
